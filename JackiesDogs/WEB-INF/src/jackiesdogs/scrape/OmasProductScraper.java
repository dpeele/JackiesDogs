...
public class OmasProductScraper implements Callable<ProductGroup>{
	...
	/*constructor to pass productUtility bean for database access, url to be tested, website product id, and product category*/ 
	public OmasProductScraper (ProductUtility productUtility, String urlString, int category) {
